<template>
  <div class="service flex">
    <div class="left">
      ...
      <div class="heading2">We Cover A Big Variety Of Medical Services</div>
      <p class="p">
        We provide the special tips and advice’s of heath care treatment and
        high level of best.
      </p>
      <button class="button">All Service</button>
    </div>
    <div
      ref="cardsContainer"
      @mousedown="startDrag"
      ...
      @mouseup="endDrag"
      @mouseleave="endDrag"
      class="right flex cards-container"
    >
      <div class="box">
        ...
        <div class="heading2">Diagnostics</div>
        <p class="p">
      ...
      <div class="box">
        ...
        <div class="heading2">Treatment</div>
        <p class="p">
          Phasellus venenatis porta rhoncus. Integer et viverra felis.
        </p>
        <button class="button">View More</button>
      ...
      <div class="box">
        ...
        <div class="heading2">Surgery</div>
        <p class="p">
          Phasellus venenatis porta rhoncus. Integer et viverra felis.
        </p>
        <button class="button">View More</button>
      ...
      <div class="box">
        ...
        <div class="heading2">Vaccine</div>
        <p class="p">
          Phasellus venenatis porta rhoncus. Integer et viverra felis.
        </p>
        <button class="button">View More</button>
      ...
      <div class="box">
        ...
        <div class="heading2">Emergency</div>
        <p class="p">
          Phasellus venenatis porta rhoncus. Integer et viverra felis.
        </p>
        <button class="button">View More</button>
...
export default {
  ...
  setup() {
    ...
    const onDrag = (e) => {
      ...
      cardsContainer.value.scrollLeft = scrollLeft - walk;
    };
...
.right .box {
  ...
  background-image: url(../assets/servbg.png);
